...
<template>
  <div class="bg-gray-50 min-h-screen font-sans py-12 px-4 sm:px-6">
    <div v-if="isLoading" class="min-h-screen flex items-center justify-center">
      <Icon icon="mdi:loading" class="w-12 h-12 text-emerald-500 animate-spin" />
    </div>
    ...
    <div v-else-if="errorMessage" class="max-w-2xl mx-auto text-center">
      ...
      <button @click="router.back()" class="mt-6 bg-emerald-600 text-white font-bold py-3 px-6 rounded-xl">
        Kembali
      </button>
    </div>
    ...
    <div v-else-if="transactionDetails" class="max-w-2xl mx-auto">
      <div class="bg-white rounded-3xl shadow-2xl border border-gray-100">
        <div class="p-8 text-center bg-emerald-600 rounded-t-3xl">
          <Icon icon="mdi:check-decagram" class="w-16 h-16 text-white mx-auto animate-bounce" />
        ...
        <div class="p-8 space-y-6">
          ...
          <div class="pb-6 border-b border-gray-200">
            ...
            ">
              <img :src="getImageUrl(transactionDetails.reservation.offer.image_url)
              ...
              <div>
                ...
                <p class="text-lg font-black text-gray-900 mt-1">
                  ...
                  <span class="text-sm font-medium text-gray-600">x {{ transactionDetails.reservation.quantity }}</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="space-y-3 text-sm">
              ...
              <div class="flex justify-between font-bold text-lg border-t border-dashed pt-3 mt-3">
            ...
            <div class="mt-6 flex items-center gap-3 bg-emerald-50 p-4 rounded-2xl border border-emerald-200">
              <Icon :icon="getPaymentMethodDetails(transactionDetails.payment_method)
                  .icon
